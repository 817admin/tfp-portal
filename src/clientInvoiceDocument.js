...
export const CLIENT_TERMS = [
  ...
  { title: "Logistics", body: "Freight and delivery to the Miami area are not included in quoted prices. All quoted logistics costs are estimated based on current freight rates at the time of quoting and are subject to adjustment should carrier rates increase prior to or at time of shipment. Delivery is curbside or to an accessible loading area unless otherwise agreed in writing." },
